...
- Ex) *강원도의 카페를 보여줘*, *주변에 국군복지단 마트 좀 보여줄래?*
- 세부 장소를 보고 싶을 경우 검색합니다.
- Ex) *경기도 음식점 중에 포천 검색해줘*

**2. 장소 추천**
- 조건을 명시하고 추천을 요청하면 알맞은 장소를 추천해줍니다.
- Ex) *경기도에 식당 추천해줘*, *주변에 카페 좀 추천해줄래?*

**3. 광고 수주**
- 광고를 넣고 싶으십니까? 넣고 싶다고 말하십시오!
- Ex) *나 광고 넣고 싶으니까 너희 사장 데려와*

해당 내용을 다시 보고 싶으시다면 *도움*을 입력해주십시오.
`
